...
<form role="form" id="classSelectionForm" method="post" action="pickProcessor.php">
	...
	<div class="form-group">
    	...
    	<span class="block"><input type="checkbox" name="inputTimesots" value="8:30-11:30"> 8:30-11:30</span>
    	<span class="block"><input type="checkbox" name="inputTimesots" value="9:30-11:30"> 9:30-11:30</span>
    	<span class="block"><input type="checkbox" name="inputTimesots" value="1:00-4:00"> 1:00-4:00</span>
    	<span class="block"><input type="checkbox" name="inputTimesots" value="4:00-6:00"> 4:00-6:00</span>
    	<span class="block"><input type="checkbox" name="inputTimesots" value="6:15-9:15"> 6:15-9:15</span>
    	<span class="block"><input type="checkbox" name="inputTimesots" value="No Fridays"> No Fridays</span>
	</div>
